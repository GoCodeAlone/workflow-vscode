...
> This extension requires workflow engine v0.69.4 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.69.4
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.69.4
```
