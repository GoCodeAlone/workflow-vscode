...
> This extension requires workflow engine v0.5.0 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.5.0
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.5.0
```
