...
> This extension requires workflow engine v0.18.11.1 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.18.11.1
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.18.11.1
```
