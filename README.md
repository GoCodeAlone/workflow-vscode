...
> This extension requires workflow engine v0.21.1 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.21.1
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.21.1
```
