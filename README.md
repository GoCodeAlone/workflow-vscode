...
> This extension requires workflow engine v0.74.7 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.74.7
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.74.7
```
