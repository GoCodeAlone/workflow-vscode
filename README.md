...
> This extension requires workflow engine v0.3.34 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.3.34
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.3.34
```
