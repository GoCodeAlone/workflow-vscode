...
> This extension requires workflow engine v0.80.8 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.80.8
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.80.8
```
