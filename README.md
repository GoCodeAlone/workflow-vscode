...
> This extension requires workflow engine v0.17.5 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.17.5
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.17.5
```
