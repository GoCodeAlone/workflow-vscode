...
> This extension requires workflow engine v0.69.2 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.69.2
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.69.2
```
