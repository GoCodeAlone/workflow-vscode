...
> This extension requires workflow engine v0.20.5 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.20.5
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.20.5
```
