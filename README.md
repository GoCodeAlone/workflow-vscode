...
> This extension requires workflow engine v0.60.16 or later.
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.60.16
```
...
```sh
go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.60.16
```
